    ...
    internal class ModuleWorkflow
    {
        ...
        public async Task ClassworkAsync()
        {
            try
            {
                ...
                //3 - add a new word document resource.
