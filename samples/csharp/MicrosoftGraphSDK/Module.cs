...
namespace MicrosoftGraphSDK
{
    ...
    public class Module
    {
        ...
        public static async Task<EducationModule> CreateSampleAssignmentAsync(
            ...
            string description)
        {
            try
            {
                ...
                throw new GraphException($"CreateSampleAssignmentAsync call: {ex.Message}", ex, classId, displayName, description);
            }
        }
