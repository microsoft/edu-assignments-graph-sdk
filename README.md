...
|:--:|:-------------------|:----------------------------------------------------------------------------------------------|:--------|:--------|
|1| Reassign submission   | Sample showing how the teacher creates an assignment and then publish it; the student submit his work and then teacher reassign it with feedback.|[View](https://github.com/microsoft/edu-assignments-graph-sdk/blob/main/samples/csharp/MicrosoftEduGraphSamples/Workflows/SubmissionWorkflow.cs#L27)|Delegated|
|2| Filter archived and deleted classes from assignments | Get me assignments from active and non-archived classes. |[View](https://github.com/microsoft/edu-assignments-graph-sdk/blob/main/samples/csharp/MicrosoftEduGraphSamples/Workflows/AssignmentWorkflow.cs#L26)|Delegated|
...
|6| GetRecentlyModifiedSubmission   | The sample shows how the teacher creates a bulk assignments and publish the assignments. Retrieve submissions modified in the previous seven days. |[View](https://github.com/microsoft/edu-assignments-graph-sdk/blob/main/samples/csharp/MicrosoftEduGraphSamples/Workflows/SubmissionWorkflow.cs#L26)|Delegated and Application|
